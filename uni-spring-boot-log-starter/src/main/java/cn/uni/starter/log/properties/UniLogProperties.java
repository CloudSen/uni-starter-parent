...
//public class UniLogProperties implements EnvironmentAware, EnvironmentCapable {
//
//    @Nullable
...
//        Objects.requireNonNull(environment, "Spring boot 环境下 Environment 不可能为null");
//        return environment.getProperty("spring.application.name", environment.getProperty("spring.application.name", ""));
//    }
//
//    @Override
